...
class TCNN(nn.Module):
    ...
    def __init__(self):
        ...
        self.DConv2d_7 = nn.ConvTranspose2d(
            in_channels=128,
            out_channels=64,
            kernel_size=(2, 5),
            stride=(1, 2),
        ...
        self.DConv2d_6 = nn.ConvTranspose2d(
            in_channels=128,
            out_channels=32,
            kernel_size=(2, 5),
            stride=(1, 2),
        ...
        self.DConv2d_5 = nn.ConvTranspose2d(
            in_channels=64,
            out_channels=32,
            kernel_size=(2, 5),
            stride=(1, 2),
        ...
        self.DConv2d_4 = nn.ConvTranspose2d(
            in_channels=64,
            out_channels=16,
            kernel_size=(2, 5),
            stride=(1, 2),
        ...
        self.DConv2d_3 = nn.ConvTranspose2d(
            in_channels=32,
            out_channels=16,
            kernel_size=(2, 5),
            stride=(1, 2),
        ...
        self.DConv2d_2 = nn.ConvTranspose2d(
            in_channels=32,
            out_channels=16,
            kernel_size=(2, 5),
            stride=(1, 2),
        ...
        self.DConv2d_1 = nn.ConvTranspose2d(
            in_channels=32,
            out_channels=1,
            kernel_size=(2, 5),
            stride=(1, 1),
